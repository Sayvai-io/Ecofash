        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-20">
          <div className="flex flex-wrap">
            ...
            <div className="w-full lg:w-2/3 pl-4">
              <h1 className="text-5xl text-[#0e0d0d] font-extrabold mb-2">Mapping Your Path to</h1>
              <h2 className="text-5xl text-[#609641] font-extrabold mb-6">Sustainable Supply Chains.</h2>
              <p className="mb-4">
