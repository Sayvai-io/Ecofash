...
const ServicesHome = () => {
  return (
    <div className="flex flex-col md:flex-row justify-between items-center py-12 px-4 md:px-8">
      <div className="md:w-1/2 mb-8 md:mb-0">
        <h2 className="text-3xl font-bold mb-4">
          Guiding Brands to a{' '}
          <span className="text-[#609641] font-bold text-3xl">Greener</span> Future
        </h2>
      </div>
