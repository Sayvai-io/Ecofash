        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-20">
          <div className="flex flex-wrap">
            ...
            <div className="w-full lg:w-1/3 pr-8 mb-8 lg:mb-0">
              ...
              <div className="mb-12">
                ...
                <ul className="space-y-4">
                  <li>
                    <Link href="/services/b-corp-certification" className="flex text-lg font-semibold items-center hover:text-[#609641] pb-4 border-b-2 border-gray-200">
            ...
            <div className="w-full lg:w-2/3 pl-4">
              <h1 className="text-5xl text-[#0e0d0d] font-extrabold mb-2">Charting Your Path to</h1>
              <h2 className="text-5xl text-[#609641] font-extrabold mb-6">Carbon Neutrality.</h2>
              <p className="mb-4">
...
export default CarbonNeutralPlanning;
