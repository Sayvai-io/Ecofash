          ...
          <div className="py-20 lg:py-25">
            <div className="flex flex-wrap gap-8 lg:justify-between lg:gap-0">
              ...
              >
                ...
                <br />
                <span className="text-2xl">on sustainability</span>
                </p>
...
>
<ul className="flex items-center gap-5 p-8 -ml-8">
      <li>
      <a href="#" aria-label="social icon">
      <div className="border-2 border-white p-2 rounded-full transition-all duration-300 hover:border-green-500 hover:bg-green-500">
  <svg
